...
3. Edit `Sources/Sketch0718MemoryStress/App.swift`, then `build_status`, then `snapshot`.
...
- Entry point: `Sources/Sketch0718MemoryStress/App.swift`
- Images: `Sources/Sketch0718MemoryStress/Resources/Images/`
- Models: `Sources/Sketch0718MemoryStress/Resources/Models/`
- Shaders: `Sources/Sketch0718MemoryStress/Resources/Shaders/`
- Presets: `Sources/Sketch0718MemoryStress/Presets/default.json`
