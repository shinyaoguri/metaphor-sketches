...
3. Edit `Sources/Sketch0816Marionette/App.swift`, then `build_status`, then `snapshot`.
...
- Entry point: `Sources/Sketch0816Marionette/App.swift`
- Images: `Sources/Sketch0816Marionette/Resources/Images/`
- Models: `Sources/Sketch0816Marionette/Resources/Models/`
- Shaders: `Sources/Sketch0816Marionette/Resources/Shaders/`
- Presets: `Sources/Sketch0816Marionette/Presets/default.json`
