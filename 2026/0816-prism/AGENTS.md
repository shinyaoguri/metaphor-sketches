...
3. Edit `Sources/Sketch0816Prism/App.swift`, then `build_status`, then `snapshot`.
...
- Entry point: `Sources/Sketch0816Prism/App.swift`
- Images: `Sources/Sketch0816Prism/Resources/Images/`
- Models: `Sources/Sketch0816Prism/Resources/Models/`
- Shaders: `Sources/Sketch0816Prism/Resources/Shaders/`
- Presets: `Sources/Sketch0816Prism/Presets/default.json`
