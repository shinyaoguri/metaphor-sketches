...
3. Edit `Sources/Sketch0816Galley/App.swift`, then `build_status`, then `snapshot`.
...
- Entry point: `Sources/Sketch0816Galley/App.swift`
- Images: `Sources/Sketch0816Galley/Resources/Images/`
- Models: `Sources/Sketch0816Galley/Resources/Models/`
- Shaders: `Sources/Sketch0816Galley/Resources/Shaders/`
- Presets: `Sources/Sketch0816Galley/Presets/default.json`
