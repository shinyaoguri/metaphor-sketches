...
3. Edit `Sources/Sketch0816Gamut/App.swift`, then `build_status`, then `snapshot`.
...
- Entry point: `Sources/Sketch0816Gamut/App.swift`
- Images: `Sources/Sketch0816Gamut/Resources/Images/`
- Models: `Sources/Sketch0816Gamut/Resources/Models/`
- Shaders: `Sources/Sketch0816Gamut/Resources/Shaders/`
- Presets: `Sources/Sketch0816Gamut/Presets/default.json`
