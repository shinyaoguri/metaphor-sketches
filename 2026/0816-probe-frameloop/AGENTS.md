...
3. Edit `Sources/Sketch0816ProbeFrameloop/App.swift`, then `build_status`, then `snapshot`.
...
- Entry point: `Sources/Sketch0816ProbeFrameloop/App.swift`
- Images: `Sources/Sketch0816ProbeFrameloop/Resources/Images/`
- Models: `Sources/Sketch0816ProbeFrameloop/Resources/Models/`
- Shaders: `Sources/Sketch0816ProbeFrameloop/Resources/Shaders/`
- Presets: `Sources/Sketch0816ProbeFrameloop/Presets/default.json`
