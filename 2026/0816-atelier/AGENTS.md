...
3. Edit `Sources/Sketch0816Atelier/App.swift`, then `build_status`, then `snapshot`.
...
- Entry point: `Sources/Sketch0816Atelier/App.swift`
- Images: `Sources/Sketch0816Atelier/Resources/Images/`
- Models: `Sources/Sketch0816Atelier/Resources/Models/`
- Shaders: `Sources/Sketch0816Atelier/Resources/Shaders/`
- Presets: `Sources/Sketch0816Atelier/Presets/default.json`
