...
| <img src="https://i.gyazo.com/4dd6ed0ba0d872abb494c0d645da35fa.gif" width="200"> | [0816-marionette](2026/0816-marionette/)<br><sub>3d / metaphor 0.13.0</sub> | 2D の Verlet 物理を糸に、3D シーングラフを操り人形に見立てる。鎖・布・坑・群れの 4 場面 | [#10](https://github.com/shinyaoguri/metaphor-sketches/issues/10) |
| <img src="https://i.gyazo.com/9e4eb40f6c6df08cde11bbb2769d0352.gif" width="200"> | [0816-sounding](2026/0816-sounding/)<br><sub>audio-reactive / metaphor 0.13.0</sub> | 音で深さを測る。自分で合成した曲を解析し返し、その帯域でノイズの海底を彫って等深線の海図にする | [#11](https://github.com/shinyaoguri/metaphor-sketches/issues/11) |
| <img src="https://i.gyazo.com/2be4f90539137887610911cb4d0f17b2.gif" width="200"> | [0816-escapement](2026/0816-escapement/)<br><sub>2d / metaphor 0.13.0</sub> | スケルトン時計。数・イージング・波形・乱数・定数・時計・ループ制御・入力という「もっとも基本的な層」を、作品自身が数式と突き合わせる。切り分けは [0816-probe-frameloop](2026/0816-probe-frameloop/) | [#12](https://github.com/shinyaoguri/metaphor-sketches/issues/12) |
...
| <img src="https://i.gyazo.com/8346a81388e93825d14a4ab082aa997d.gif" width="200"> | [0816-prism](2026/0816-prism/)<br><sub>2d / metaphor 0.13.0</sub> | プリズムで白色光を分け、加算で白へ戻す。**指定した色が本当にその色のピクセルになるか**をオフスクリーンに焼いて読み戻す層を持つ | [#14](https://github.com/shinyaoguri/metaphor-sketches/issues/14) |
...
| <img src="https://i.gyazo.com/b26297f517e80c37e74d60992aeb53e0.gif" width="200"> | [0816-atelier](2026/0816-atelier/)<br><sub>3d / metaphor 0.13.0</sub> | アトリエ。石膏デッサンの静物を組み込みの 3D で組み、**作品自身が講師の赤鉛筆になって**形・明暗・奥行き・影の狂いを測る。期待値は metaphor を呼ばずに手で解き、焼き上がった画素と突き合わせる | [#17](https://github.com/shinyaoguri/metaphor-sketches/issues/17) |
| <img src="https://i.gyazo.com/64f796b68bbc648417a6dc0d2913ee84.gif" width="200"> | [0816-encore](2026/0816-encore/)<br><sub>2d / metaphor 0.14.0</sub> | 影絵劇場。動くものは 1 つ残らず `Tween` に予約されている。同じ振付の座組を 2 つ並べ、**アンコールで登録し直すかどうかだけ**を変えたら、片方の役者が袖から出てこなくなった | [#18](https://github.com/shinyaoguri/metaphor-sketches/issues/18) |
| <img src="https://i.gyazo.com/3c02bd5414e3fe498fd75c5e3ee246b5.gif" width="200"> | [0816-emulsion](2026/0816-emulsion/)<br><sub>2d + 3D オフスクリーン / metaphor 0.13.0</sub> | 乳剤。2D の版と 3D の被写体を別々の層に焼き、`RenderGraph` で 1 枚に重ねる。**焼く側・貼る側・パスで合成する側の α 前提が三者三様**なのを、同じ 2 層を 3 通りで重ねて炙り出した | [#19](https://github.com/shinyaoguri/metaphor-sketches/issues/19) |
| <img src="https://i.gyazo.com/d27d3b98327093429083a06232868b45.gif" width="200"> | [0816-triptych](2026/0816-triptych/)<br><sub>2d / metaphor 0.10.0</sub> | 三連祭壇画。1 つの世界を 3 枚のウィンドウに分けて描き、**継ぎ目が合うか**を絵と数値の両方で見る。翼の開閉が構成そのものなので、**閉じて開き直すと落ちた**穴を踏んだ（v0.10.0 で直り、当て木は外した）。切り分けは [0816-probe-windowclose](2026/0816-probe-windowclose/) | [#20](https://github.com/shinyaoguri/metaphor-sketches/issues/20) |
| <img src="https://i.gyazo.com/f5f65143a815d932f69b11835775fec6.webp" width="200"> | [0823-switchboard](2026/0823-switchboard/)<br><sub>2d / metaphor 0.13.0 + metaphor-syphon 0.2.0</sub> | 電話交換台。1 枚の最終フレームが分岐して複数の出力プラグインへ落ちる。**旧 registry の「後勝ちで上書き」が直ったか**は出力先を同時に立てないと当たらないので、自作 2 本と別パッケージになった実物の Syphon を同じ盤面に並べた | [#23](https://github.com/shinyaoguri/metaphor-sketches/issues/23) |
| <img src="https://i.gyazo.com/b3cf58acf8bf7173165031ae5fbe1d7e.webp" width="200"> | [0823-darkroom](2026/0823-darkroom/)<br><sub>syphon / metaphor 0.13.0 + metaphor-syphon 0.2.0</sub> | 暗室。1 枚の原版が 3 つの現像槽（MPS）を通り、**3 本の Syphon 線**で外へ出ていく。3 本が取り違えていないか・連動しているかは**受け手にしか読めない**（`loadPixels` は現像前を返す）ので、3 本を受信して数値で判定する道具ごと作った | [#25](https://github.com/shinyaoguri/metaphor-sketches/issues/25) |
| <img src="https://i.gyazo.com/bb4fab357e7a20847436f4811dd49136.webp" width="200"> | [0824-duet](2026/0824-duet/)<br><sub>2d / metaphor 0.13.0</sub> | 二重奏。一つの渦を左手 = CPU の Swift ループ、右手 = GPU の MSL カーネルが同時に弾く。右手だけ左右を映して描くので、**正しければ画面は左右対称**になり、ズレれば継ぎ目が桁ごとに灯る。**期待値を CPU 側で解ける**ので、GPU の口の狂いが印象ではなく数字で出る | [#26](https://github.com/shinyaoguri/metaphor-sketches/issues/26) |
| <img src="https://i.gyazo.com/92b74ad89f76aa25b06ea8dfd233c4cf.webp" width="200"> | [0824-insignia](2026/0824-insignia/)<br><sub>3d / metaphor 0.13.0</sub> | 記章。metaphor のロゴを、四方から検分できる立体にする。横から見れば `m`、軸から覗けば渦。**metaphor はバックフェースを一切カリングしない**ので、面が裏返っても消えず陰影だけが静かに壊れる — 巻き順は目で確かめられないので、53,664 枚の三角形を作品自身が数えて判定する | [#27](https://github.com/shinyaoguri/metaphor-sketches/issues/27) |
